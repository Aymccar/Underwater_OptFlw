...
void AP_Motors6DOF::setup_motors(motor_frame_class frame_class, motor_frame_type frame_type)
{
	...
	add_motor_raw_6dof(AP_MOTORS_MOT_2,     0,          	0,              1.0f,          0,              1.0f,           	1.0f,          	2);
	add_motor_raw_6dof(AP_MOTORS_MOT_3,     -1.0f,           0,           	0,           -1.0f,          -1.0f,           	1.0f,          	3);
	add_motor_raw_6dof(AP_MOTORS_MOT_4,     0,          	1.0f,           0,            0,             -1.0f,           	1.0f,         	4);
	add_motor_raw_6dof(AP_MOTORS_MOT_5,     0,           	0,           	1.0f,         -1.0f,          -1.0f,           	-1.0f,          5);
	add_motor_raw_6dof(AP_MOTORS_MOT_6,     -1.0f,          1.0f,           1.0f,       0,              -1.0f,           	-1.0f,          6);
	add_motor_raw_6dof(AP_MOTORS_MOT_7,     0,              1.0f,           0,           -1.0f,          1.0f,           	-1.0f,          7);
	add_motor_raw_6dof(AP_MOTORS_MOT_8,     -1.0f,           0,             0,           0,              1.0f,           	-1.0f,          8);
        break;
